...
export default async function JanitorMaintenancePage() {
  ...
  return (
    <div className="flex-1 space-y-6 p-6 md:p-10">
      <div>
        ...
        <p className="text-muted-foreground">Übersicht aller Ihnen zugewiesenen Wartungsaufträge</p>
      </div>
        ...
        {tasks.length === 0 ? (
          <Card className="border-border/40 bg-card/50 backdrop-blur-sm">
            <CardContent className="flex flex-col items-center justify-center py-16">
              ...
              <p className="mt-4 text-lg font-medium">Keine Wartungen</p>
              <p className="text-muted-foreground">Ihnen sind derzeit keine Wartungsaufträge zugewiesen</p>
            </CardContent>
          </Card>
        ) : (
          tasks.map((task) => (
